...
exports.list = async (req, res) => {
    try {
        ...
        const games = await Games.find({platform: "Wii U"});
        res.render("NintendoWiiU", { games: games, message: message });
    } catch (e) {
...
exports.update = async (req, res) => {
    ...
    try{
        ...
        res.redirect('/NintendoWiiU/?message=game has been updated');
    } catch (e) {
        res.status(404).send({
            message: `could not find game ${id}`
        });
