...
exports.list = async (req, res) => {
    try {
        ...
        const games = await Games.find({platform: "Nintendo 3DS"});
        res.render("Nintendo3DS", { games: games, message: message });
    } catch (e) {
...
exports.update = async (req, res) => {
    ...
    try{
        ...
        res.redirect('/Nintendo3DS/?message=game has been updated');
    } catch (e) {
        res.status(404).send({
            message: `could not find game ${id}`
        });
